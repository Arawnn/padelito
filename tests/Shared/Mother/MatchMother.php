...
final class MatchMother
{
    ...
    public function build(): PadelMatch
    {
        return PadelMatch::reconstitute(
            ...
            creator: PlayerId::fromString($this->creatorId),
            partner: $this->teamAPlayer2Id ? PlayerId::fromString($this->teamAPlayer2Id) : null,
            opponent1: $this->teamBPlayer1Id ? PlayerId::fromString($this->teamBPlayer1Id) : null,
            opponent2: $this->teamBPlayer2Id ? PlayerId::fromString($this->teamBPlayer2Id) : null,
